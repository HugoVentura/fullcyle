...
namespace FC.CodeFlix.Catalog.UnitTests.Domain.Entity.Genre
{
    ...
    public class GenreTest
    {
        ...
        public GenreTest(GenreTestFixture fixture) => this._fixture = fixture;

        [Fact(DisplayName = nameof(Instantiate))]
        [Trait("Domain", "Genre - Aggregates")]
        public void Instantiate()
        {
            var genreName = this._fixture.GetValidName();
        ...
        {
            var genre = this._fixture.GetExampleGenre(isActive);
        ...
        public void Update()
        {
            var genre = this._fixture.GetExampleGenre();
            var newName = this._fixture.GetValidName();
        ...
        public void RemoveCategory()
        {
            ...
            var genre = this._fixture.GetExampleGenre(categoryIdList: new List<Guid>()
            {
                Guid.NewGuid(),
                Guid.NewGuid(),
                exampleGuid,
