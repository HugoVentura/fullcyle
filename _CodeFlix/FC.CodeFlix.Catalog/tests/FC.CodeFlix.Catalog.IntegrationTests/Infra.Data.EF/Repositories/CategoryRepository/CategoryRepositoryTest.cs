...
namespace FC.CodeFlix.Catalog.IntegrationTests.Infra.Data.EF.Repositories.CategoryRepository
{
    ...
    public class CategoryRepositoryTest
    {
        ...
        public async Task Insert()
        {
            ...
            var exampleCategory = this._fixture.GetExampleCategory();
            var categoryRepository = new Repository.CategoryRepository(dbContext);

            await categoryRepository.Insert(exampleCategory, CancellationToken.None);
            await dbContext.SaveChangesAsync(CancellationToken.None);

            var dbCategory = await this._fixture.CreateDbContext(true).Categories.FindAsync(exampleCategory.Id);
        ...
        public async Task Get()
        {
            CodeFlixCatalogDbContext dbContext = this._fixture.CreateDbContext();
            var exampleCategory = this._fixture.GetExampleCategory();
            var exampleCategories = this._fixture.GetExampleCategoryList(15);
            exampleCategories.Add(exampleCategory);
            await dbContext.AddRangeAsync(exampleCategories);
            await dbContext.SaveChangesAsync(CancellationToken.None);
            var categoryRepository = new Repository.CategoryRepository(this._fixture.CreateDbContext(true));
        ...
        public async Task GetThrowIfNotFound()
        {
            ...
            await dbContext.AddRangeAsync(this._fixture.GetExampleCategoryList(15));
            await dbContext.SaveChangesAsync(CancellationToken.None);
            var categoryRepository = new Repository.CategoryRepository(dbContext);
        ...
        public async Task Update()
        {
            CodeFlixCatalogDbContext dbContext = this._fixture.CreateDbContext();
            var exampleCategory = this._fixture.GetExampleCategory();
            var newExampleCategory = this._fixture.GetExampleCategory();
        ...
        {
            CodeFlixCatalogDbContext dbContext = this._fixture.CreateDbContext();
            var exampleCategoriesList = this._fixture.GetExampleCategoryListWithNames(new List<string>() 
        ...
        {
            CodeFlixCatalogDbContext dbContext = this._fixture.CreateDbContext();
            var exampleCategoriesList = this._fixture.GetExampleCategoryList(10);
            await dbContext.AddRangeAsync(exampleCategoriesList);
            await dbContext.SaveChangesAsync(CancellationToken.None);
            var categoryRepository = new Repository.CategoryRepository(dbContext);
            ...
            var expectedOrderedList = this._fixture.CloneCategoryListOrdered(exampleCategoriesList, orderBy, searchOrder);
            output.Should().NotBeNull();
            output.Items.Should().NotBeNull();
            output.CurrentPage.Should().Be(searchInput.Page);
            output.PerPage.Should().Be(searchInput.PerPage);
